...
L["Show Title"] = "顯示標題"
L["The in-game navigation is disabled! Not all features of RCReadyCheck will work properly. Do you want to enable it?"] =
"遊戲內導航已停用! 不是所有的 RCReadyCheck 功能都能正常運作. 你想要啟用他嗎?"
L["Title"] = "標題"
