...
---@param func function
---@param ... any
function RCReadyCheck:RegisterCallback(callbackEvent, func, ...)
...
---@param callbackEvent CallbackEvent
---@param func function
function RCReadyCheck:UnregisterCallback(callbackEvent, func)
    assert(callbackEvent, "Callback event must be provided")
    assert(CALLBACK_EVENTS[callbackEvent], "Callback event is not valid event")
    assert(func, "Function must be provided")
...
---@param callbackEvent CallbackEvent
---@param ... any
function RCReadyCheck:FireCallback(callbackEvent, ...)
    assert(callbackEvent, "Callback event must be provided")
    assert(CALLBACK_EVENTS[callbackEvent], "Callback event is not valid event")
...
---@param ... unknown
function RCReadyCheck:CallRestricted(func, warning, ...)
