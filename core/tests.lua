...
function RCReadyCheck:Test(name, func)
...
---@return number
function RCReadyCheck:GetNumberOfTests()
    return #(self.tests or {})
end

---Get all tests that have been registered
---@return Test[]
function RCReadyCheck:GetTests()
    return self.tests
end
...
function RCReadyCheck:RunTests(onUpdate, onFinish)
