...
function RCReadyCheck:SetSlashTrigger(trigger, triggerIndex)
...
function RCReadyCheck:SetDefaultAction(func)
...
function RCReadyCheck:RemoveSlashCommand(command)
    assert(type(command) == "string", "Command not provided")
...
function RCReadyCheck:EnableHelpCommand()
