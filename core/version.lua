...
local version = C_AddOns.GetAddOnMetadata(RCReadyCheck.name, "Version")
...
RCReadyCheck.numericVersion = numericVersion
RCReadyCheck.version = version
...
for i, ver in ipairs(testVersionString) do
    ...
    RCReadyCheck:Test("Version number conversion: " .. i, function(test)
